...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new HelloMessage(this).execute("http://10.0.2.2:9000/Application/InicialitzarBaseDades" );
    }
    EditText cantant;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    cantant =findViewById(R.id.EditQuery);
                    String query = String.format("http://10.0.2.2:9000/Application/NombreDiscs?nom="+cantant.getText().toString());
